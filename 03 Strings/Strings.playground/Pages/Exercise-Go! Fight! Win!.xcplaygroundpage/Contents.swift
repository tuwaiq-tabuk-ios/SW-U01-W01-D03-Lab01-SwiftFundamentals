...
let schoolName = "DownTown Schools"
let refrain = "wake up with a smile, it's another day at \(schoolName), we're looking forward to a bucket full of fun and heaps of learning at \(schoolName)"
