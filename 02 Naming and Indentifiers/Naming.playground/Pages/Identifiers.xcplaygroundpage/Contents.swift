...
let numberOfPot_bellied_pig = 1

let totalNumberOfAnimals2 = numberOfDogs2 + numberOfCats2 + numberOfTurtles2 + numberOfHamsters + numberOfFish + numberOfsnake + numberOfPot_bellied_pig

let totalNumberOfMammals2 = numberOfDogs2 + numberOfCats2 + numberOfHamsters2 + numberOfPot_bellied_pig
