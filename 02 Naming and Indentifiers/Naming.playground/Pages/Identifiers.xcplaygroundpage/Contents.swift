...
let TotalNumberOfAnimals = NumberOfPig + NumberOfFish + NumberOfSnake

let TotalNumberOfMammals = NumberOfPig

let TotalNumberOfNotMammal = NumberOfSnake + NumberOfFish
