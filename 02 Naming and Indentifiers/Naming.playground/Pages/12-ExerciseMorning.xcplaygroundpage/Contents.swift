...
let totalTime = brushTeeth +  chooseClothes + shower + goJogging + finishHomework +  fixLunch
...
let toDo = shower + goJogging + finishHomework + fixLunch + brushTeeth
let whatDoIIikeToDo = uploadPhotos + chooseClothes
/*:
...
let uploadPhotos2=10

let chooseClothes2 = 5

let shower2 = 10

let goJogging2 = 40

let finishHomework2 = 50
