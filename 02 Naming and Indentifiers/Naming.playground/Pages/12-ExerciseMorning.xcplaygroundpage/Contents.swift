...
let groupsOfLikeTodo = brushTeeth + fixLunch
let groupsOfDontLikeTodo = uploadPhotos + chooseClothes
let groupsOfLikeTodoAndgroupsOfDontLikeTodo = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
