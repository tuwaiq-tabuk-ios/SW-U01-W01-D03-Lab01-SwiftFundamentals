...
// Exercice 2
let TakeTime = 3 + 2 + 5 + 25 + 15 + 40 + 10

//Exercice 3
let ThingIhaveToDo = brushTeeth + Gojogging + FinishHomeWork
let ThingIlikeToDo = Shower + ChooseClothes

let IdoNotHaveToDo = UploadPhotos + FixLunch


//Exercice 4
 let TakaShowerWithUseMobile = 30
let GoFoerAlongerRun = 20
