...
let Ido = brushTeeth + shower + finishHomework + fixLunch
let Iliketodo = uploadPhotos + goJogging + chooseClothes
...
*/
let totalTime2 = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
