...
let thingsIHaveToDo = brushTeeth + chooseClothes + finishHomework + fixLunch
...
let chooseClothes2 = 10

let shower2 = 20

let goJogging2 = 15

let finishHomework2 = 30

let fixLunch2 = 30

let totalTimeSpent = brushTeeth2 + uploadPhotos2 + chooseClothes2 + shower2 +
goJogging2 + finishHomework2 + fixLunch2
