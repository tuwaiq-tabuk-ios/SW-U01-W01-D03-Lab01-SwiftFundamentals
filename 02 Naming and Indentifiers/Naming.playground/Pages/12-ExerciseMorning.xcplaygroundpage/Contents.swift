...
let  fixLunch = 6
let total = uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let  shower2 = 40
let goJogging2 = 1
let finishHomework2 = 3
let  fixLunch2 = 6
let cooking = 35
let sport = 30
let move = 50
let total2 =  uploadPhotos2 + chooseClothes2 + shower2 + goJogging2 + finishHomework2 + fixLunch2 + cooking + sport + move
...
let thingsyouhavetodo = [cooking,shower,sport,]
let thingsyouliketodo = [uploadPhotos ,sport ,finishHomework,move]
let thingsyoudonothavetodo = [cooking ,chooseClothes]
...
let brushTeeth1 = 3
let uploadPhotos1 = 2
let chooseClothes1 = 2
let  shower1 = 15
let goJogging1 = 1
let finishHomework1 = 3
let  fixLunch1 = 6
let cooking1 = 15
let sport1 = 10
let move1 = 20
let total0 =  uploadPhotos1 + chooseClothes1 + shower1 + goJogging1 + finishHomework1 + fixLunch1 + cooking1 + sport1 + move
