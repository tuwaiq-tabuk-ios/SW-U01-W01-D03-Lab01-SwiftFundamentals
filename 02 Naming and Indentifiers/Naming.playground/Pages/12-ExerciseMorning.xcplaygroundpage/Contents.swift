...
let  fixLunch = 6
let minutes = uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
// Add more here...
...
let brushTeeth1 = 2
let uploadPhotos2 = 2
let chooseClothes3 = 12
let  shower4 = 15
let goJogging5 = 5
let finishHomework6 = 5
let  fixLunch7 = 6
let Cooking = 30
let Sports = 15
let minutes1 = uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch + Cooking + Sports
...
let Havetodo = chooseClothes + shower + goJogging + finishHomework
let ilikeDo = uploadPhotos + fixLunch
let dolike = Cooking + Sports
...
*/
let uploadPhotos21 = 1
let chooseClothes31 = 2
let  shower41 = 10
let goJogging51 = 3
let finishHomework61 = 3
let  fixLunch71 = 5
let Cooking1 = 15
let Sports1 = 10
 let mT = uploadPhotos21 + chooseClothes31 + shower41 + goJogging51 + finishHomework61 + fixLunch71 + Cooking1 + Sports1
